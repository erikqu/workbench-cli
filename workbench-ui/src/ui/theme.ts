...
const DEFS = {
  ...
  red: {
    ...
    accent: "#ef6262",
    pins: {
      "bg-surface-subtle": "#211719",
      "bg-surface-raised": "#2a1c1f",
      "bg-surface-overlay": "#211719",
      "bg-muted": "#302124",
      "fg-default": "#f2e7e7",
      "fg-muted": "#b7a2a5",
      "border-default": "#382529",
      "border-focus": "#ef6262",
      "border-accent": "#ef6262",
      "fg-accent": "#ef6262",
      "fg-accent-hover": "#ff9292",
      "bg-selected": "#452126",
      "bg-selected-hover": "#57292f",
      "fg-on-selected": "#fff5f5",
    },
    app: {
      "app-bg": "#180f11",
      "app-activity": "#120b0d",
      "app-panel-alt": "#1b1113",
      "app-input": "#1e1315",
      "term-bg": "#1b1113",
      ...darkInk,
      "diff-hunk": "#ef6262",
